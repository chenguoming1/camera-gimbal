/* =============================================================
 * mpu6050.h
 * MPU6050 driver — supports two devices on the same I2C bus
 *
 * Board IMU  : I2C1 (PB6/PB7), address 0x69 (AD0 pulled HIGH)
 * Camera IMU : I2C1 (PB6/PB7), address 0x68 (AD0 pulled LOW)
 * =============================================================*/
#ifndef MPU6050_H
#define MPU6050_H
